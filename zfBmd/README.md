...
```bash
# Morphology example
docker run -v $PWD/tmp:/tmp srp-zfbmd --morpho /app/zfBmd/test_files/test_morphology.csv --output_dir /tmp

# LPR example
docker run -v $PWD/tmp:/tmp srp-zfbmd --lpr /app/zfBmd/test_files/test_behavioral.csv --output_dir /tmp

# Both
docker run -v $PWD/tmp:/tmp srp-zfbmd --morpho /app/zfBmd/test_files/test_morphology.csv --lpr /app/zfBmd/test_files/test_behavioral.csv --output_dir /tmp
```
...
```bash
docker run -v /path/to/output_dir:/tmp srp-zfbmd ...FLAGS... --output_dir /tmp
```
