...
```bash
# Morphology example
docker run -v $PWD/tmp:/tmp srp-zfbmd --morpho /zfBmd/test_files/test_morphology.csv --output /tmp

# LPR example
docker run -v $PWD/tmp:/tmp srp-zfbmd --lpr /zfBmd/test_files/test_behavioral.csv --output /tmp

# Both
docker run -v $PWD/tmp:/tmp srp-zfbmd --morpho /zfBmd/test_files/test_morphology.csv --lpr /zfBmd/test_files/test_behavioral.csv --output /tmp
```
