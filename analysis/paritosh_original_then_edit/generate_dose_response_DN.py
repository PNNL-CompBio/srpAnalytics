...
def gen_dose_response(data_ep_cid, end_point):
    ...
    for plate_id in np.unique(data_ep_cid['plate.id']):
        ...
        print ("num_neg_ctrl_wells:" + str(num_neg_ctrl_wells)) # -> number of wells whose chemical conc=0 in each plate.id
        
        print ("neg_ctrl_wells[end_point]:" + str(neg_ctrl_wells[end_point]))
