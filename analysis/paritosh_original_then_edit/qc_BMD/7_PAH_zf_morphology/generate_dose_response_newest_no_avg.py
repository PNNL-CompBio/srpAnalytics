 ...
 #       print ("dose_response.iloc[dr_index]:\n" + str(dose_response.iloc[dr_index]))
  #      print ("dose_response.iloc[dr_index].num_embryos:" + str(dose_response.iloc[dr_index].num_embryos))
        if((dose_response.iloc[dr_index].num_embryos) < (0.25*(dose_response.iloc[dr_index].tot_wells))):
            ...
            erased_morphological_data_end_point_chemical_id_file_2nd = open(erased_morphological_data_end_point_chemical_id_filename_2nd, "a+")
            erased_morphological_data_end_point_chemical_id_file_2nd.write(write_this)
            erased_morphological_data_end_point_chemical_id_file_2nd.close()
