...
# constance
complete_file_path = '/people/kimd999/tox/phase_I_II/LPR/input/tall/344_zf_LPR_data_phase_1_2_2020JUNE25_updated_plate_id_for_TX_tall_full_w_240_endpoints.csv'
...
morph_data_file_complete_path = '/people/kimd999/tox/phase_I_II/morpho/zf_morphology_data_335_chemicals_2020DEC16.csv'

morphology_all_data = pd.read_csv(morph_data_file_complete_path, header = 0)
print(morphology_all_data.head(6))
...
print(len(lpr_filtered_data_in_minute))
...
print (delta_mov_auc_w_decreasing.head())
