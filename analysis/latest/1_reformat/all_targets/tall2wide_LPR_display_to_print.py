...
print(len(np.unique(behav_all_data['chemical.id'])))
...
print("chemical_id_count:"+str(len(np.unique(behav_all_data_select['chemical.id']))))
...
print(reformatted_w_240_endpoints)
print(reformatted_w_non_240_endpoints)
...
print(len(np.unique(reformatted_w_non_240_endpoints['chemical.id'])))
